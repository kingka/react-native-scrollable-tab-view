...
import PagerView from 'react-native-pager-view'  //update 'react-native-pager-view'
...
const AnimatedViewPagerAndroid = Platform.OS === 'android' ?
  // Animated.createAnimatedComponent(ViewPager) :   //update 'react-native-pager-view'
...
const ScrollableTabView = createReactClass({
  ...
  goToPage(pageNumber) {
    if (Platform.OS === 'ios') {
      ...
      if (this.scrollView) {
        // this.scrollView.getNode().scrollTo({x: offset, y: 0, animated: !this.props.scrollWithoutAnimation, });   //update 'react-native-pager-view'
        this.scrollView.scrollTo({x: offset, y: 0, animated: !this.props.scrollWithoutAnimation, });
      }
    } else {
      if (this.scrollView) {
        if (this.props.scrollWithoutAnimation) {
          // this.scrollView.getNode().setPageWithoutAnimation(pageNumber);   //update 'react-native-pager-view'
          this.scrollView.setPageWithoutAnimation(pageNumber);
        } else {
          // this.scrollView.getNode().setPage(pageNumber);   //update 'react-native-pager-view'
